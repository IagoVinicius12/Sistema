...
export default function Home() {
    ...
    const handle_get_all = async () => {
        try {
            ...
            setUsers(users_vet); // Agora isso vai funcionar corretamente
        } catch (err) {
    ...
    return (
        <>
            <div className='flex flex-col justify-center items-center bg-white h-svh' onLoad={handle_get_all}>
                    ...
                    <tbody>
                        {users?.map((user,index) =>
                            <tr key={index} className="hover:bg-gray-50">
                                ...
                                <td className="py-2 px-4 border-b">aa</td>
                                <td className="py-2 px-4 border-b">aaaaaaaa</td>
                                <td className="py-2 px-4 border-b text-center">aaaaaaaaaaaaa</td>
                            </tr>
                        )}
                    </tbody>
                </table>
